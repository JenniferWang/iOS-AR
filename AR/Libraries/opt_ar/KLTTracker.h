#ifndef  __OpticalFlow__KLTTracker__
#define  __OpticalFlow__KLTTracker__
...
public:
    ...
    KLTTracker(int max_points=800, cv::Size win_size = cv::Size(9, 9));
...
private:
    ...
    PointArray pre_points_;
    
    GrayscaleImage pre_frame_;
